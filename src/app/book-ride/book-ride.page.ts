...
export class BookRidePage implements OnInit, AfterViewInit {
  ...
  constructor( private router: Router, private fb: FormBuilder, private geolocation: Geolocation, private loginService: LoginService, private bookingService: BookingService) {
